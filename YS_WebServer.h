...
#if 1   //dog care
#define WEBSTR_RSQ    "POST http://qq.dogcare.com.cn/zhf/B10_10091/B10.bin HTTP/1.1"
#define WEBSTR_UPDATE "POST http://qq.dogcare.com.cn/zhf/B10_10091/jt_ads.bin HTTP/1.1"
